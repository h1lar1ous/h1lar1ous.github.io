...
<body>
    <div class="main">
        <section>
            <form action="vendor/admin-signin.php" method="post">
                <header>
                ...
                <a href="role-choice.php" class="back text-center mx-auto d-block mt-3">Еще нет аккаунта? Зарегистрируйтесь</a>
            </form>
        </section>
    </div>
</body>
