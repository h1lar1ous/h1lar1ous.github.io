...
<body>
    <div class="user-choice">
        <p class="choice-text">Выберите роль для регистрации</p>
        <div class="user-choice-wrapper">
            <div class="choice-buttons">
                <a href="register.php" class="student-btn">Ученик</a>
                <a href="teacher-register.php" class="teacher-btn">Учитель</a>
            </div>
        </div>
